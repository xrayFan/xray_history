...
void GENESISCC geQuaternion_Set( geQuaternion *Q, float W, float X, float Y, float Z);
	// set quaternion components.  Doesn't normalize
void GENESISCC geQuaternion_SetVec3d( geQuaternion *Q, float W, const geVec3d *V);
	// set quaternion components.  Doesn't normalize
...
void GENESISCC geQuaternion_GetVec3d( const geQuaternion *Q, float *W, geVec3d *V);
