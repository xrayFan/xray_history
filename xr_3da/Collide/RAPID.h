...
public:
    ...
    __forceinline float GetMinRayPickRange  ()  {return min_raypick_range;}
    __forceinline float GetModelContactCount()  {return ModelContact.count;}
    __forceinline float GetRayContactCount  ()  {return RayContact.count;}
